...
import { Animated, Pressable, ScrollView, Text, TextInput, TouchableHighlight, View } from "react-native"
    ...
    return (
        ...
        <LeftIcon/>
         ...
         <Text className="text-2xl mb-9 font-semibold">
          ...
          <Text className="text-lg font-light mb-9">
            Log in to experience better way to socialize, work and organize your finance
          </Text>
        
          <View className="bg-[#f4f4f4] p-1 rounded-full mt-3 w-full flex flex-row justify-evenly">
            <Pressable onPress={() => setSelectedTab("A")}
              className="w-[180px]"
              style={{ backgroundColor: selectedTab === "A" ? '#fff' : 'transparent', padding: 14, borderRadius: 100 }}>
              <Text className="text-[16px] text-center" style={{fontWeight: selectedTab === "A" ? "bold" : "normal" , }}>
                Regular Sign in
              </Text>
            </Pressable>
            <Pressable onPress={() => setSelectedTab("B")}
              className="w-[180px]"
              style={{ backgroundColor: selectedTab === "B" ? '#fff' : 'transparent', padding: 14, borderRadius: 100 }}>
              <Text className="text-[16px] text-center" style={{fontWeight: selectedTab === "B" ? "bold" : "normal"}}>
                Connect wallet
              </Text>
            </Pressable>
          </View>
        ...
        <Text className="text-[#fff] p-3 text-center font-semibold text-[20px]">
          ...
          <Text className="text-center px-7 mt-6 font-light">
            ...
            <Text className="text-[#F88908] font-bold">
              { " "}Klayver's {""}
            </Text>
