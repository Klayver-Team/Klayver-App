...
const ReceiveMoney = () => {
    ...
    return (
        ...
        <View className="bg-[#EAEAEA] mx-1 flex flex-row rounded-full px-2 py-1 ">
            <Text className="text-[#828282] font-semibold">{item.otherText.toUpperCase()}</Text>
        </View>
        }
        </>
        </View>
        <Text className="font-bold text-xl">{item.amount} {item.currency}</Text>
       
        </View>

        <View className="px-1 py-1 flex-row justify-between">
        <Text className="text-[#828282] text-lg font-semibold">{item.rate}</Text>
        <Text className="text-[#828282] text-xl font-semibold">{item.value}</Text>
        </View>
        </View>
        </View>
        </Link>
